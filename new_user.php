            ...
            <form action="" id="manage_user">
                ...
                <div class="row">
                    <div class="col-md-6 border-right">
                        ...
                        <div class="form-group">
                            <label for="" class="control-label">Age In Years.</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sector" class="form-control form-control-sm" required value="<?php echo isset($sector) ? $sector : '' ?>">
                        </div>
                        <div class="form-group">
        ...
        $.ajax({
            ...
            success:function(resp){
                if(resp == 1){
                    ...
                    setTimeout(function(){
                        location.replace('indexg.php?page=user_list')
                    },750)
                }else if(resp == 2){
