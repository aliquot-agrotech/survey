			...
			<div class="card card-outline card-success">
				...
				<div class="card-body ui-sortable">
					...
					<div class="callout callout-info">
						...
						<div class="col-md-12">
						<!-- <input type="hidden" name="lat" value="<//?='<script>document.writeln(ltt)</script>'; ?>">
						<input type="hidden" name="lat" value="<//?='<script>document.writeln(lngg)</script>'; ?>"> -->
				...
				<div class="card-footer border-top border-success">
					<div class="d-flex w-100 justify-content-center">
						...
						<button class="btn btn-sm btn-flat bg-gradient-secondary mx-1" type="button" onclick="location.href = 'indexg.php?page=survey_widget'">Cancel</button>
					</div>
				</div>
			</div>
		</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
						location.href = 'indexg.php?page=survey_widget'
					},2000)
				}
			}
		})
