  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="margin-top:50px">
    <div class="dropdown">
    ...
    <div class="sidebar">
      <nav class="mt-2">
        ...
        <?php if($_SESSION['login_type'] == 1): ?>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./indexg.php?page=new_user" class="nav-link nav-new_user tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./indexg.php?page=user_list" class="nav-link nav-user_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="homepage/intro.php" class="nav-link nav-new_survey tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Main</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="homepage/our_values.php" class="nav-link nav-survey_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Our Values</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="homepage/who_we_are.php" class="nav-link nav-survey_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Who we are</p>
                </a>
              </li>
              <li class="nav-item">
                ...
                <a href="homepage/pricing.php" class="nav-link nav-survey_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Pricing</p>
                </a>
              </li>
        ...
        <?php else: ?>
          <!-- <li class="nav-item">
            <a href="./indexg.php?page=survey_widget" class="nav-link nav-survey_widget nav-answer_survey">
