...
<div class="container mt-3">
  ...
  <p>Update Information: Who-we-are</p>
  <form action="updates/update_who_we_are.php" method="POST" enctype="multipart/form-data">
        <p>  
        <div class="">
        ...
        <input type="file" class="form-control" placeholder="Upload Image" name="image" id="image" value="<?=$img; ?>">
        </div> 
