...
<?php 
$answers = $conn->query("SELECT distinct(survey_id) from answers WHERE user_id = $userid");
$ans = array();
...
<div class="col-lg-12">
	...
	<div class="row">
		<?php 
		$survey = $conn->query("SELECT * FROM survey_set WHERE user_id = $userid");	
		
		while($row=$survey->fetch_assoc()):
        // print_r(ucwords($row['title']));
		// echo "Here";
		?>
               ...
               <div class="row">
               	...
               	<div class="d-flex justify-content-center w-100 text-center">
               		<?php if(!isset($ans[$row['id']])): ?>
               			<a href="indexg.php?page=answer_survey&id=<?php echo $row['id'] ?>" class="btn btn-sm bg-gradient-primary"><i class="fa fa-pen-square"></i> Take Survey</a>
               		<?php else: ?>
